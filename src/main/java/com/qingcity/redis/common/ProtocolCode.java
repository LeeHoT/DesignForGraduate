 ...
 * 
 * @author leehotin
 * @Date 2017年2月27日 下午4:20:52
 * @Description proto命令码
 */
public class ProtocolCode {
	...
	public static final int USER_SEND_INFO = 2001; // 服务器回复用户信息指令，编号2001，指令体为唯一用户标识
													// + 用户数据
	...
	public static final int BATTLE_UPLOAD_ATTACK_RESULT = 3012; // 客户端上传攻击结果
																// 发给服务器对方的
																// 被击杀的飞机油耗总和，
																// 所击杀的飞机未被击伤部分的总和，剩余飞机数
	...
	public static final int AI_BATTLE_UPLOAD_ATTACK_RESULT = 4012; // 上传双方的
																	// 被击杀的飞机油耗总和，
																	// 所击杀的飞机未被击伤部分的总和，剩余飞机数
